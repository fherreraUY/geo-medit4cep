 ...
 *   <li>{@link domain.impl.EventPropertyImpl#getImagePath <em>Image Path</em>}</li>
 *   <li>{@link domain.impl.EventPropertyImpl#getReferencedEvent <em>Referenced Event</em>}</li>
