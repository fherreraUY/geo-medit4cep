 ...
 * @generated
 */
public class EventPropertyEventPropertyEventPropertiesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getEventPropertyEventPropertyEventPropertiesCompartment_7002SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getEventPropertyEventPropertyEventPropertiesCompartment_7002SemanticChildren(
