 ...
 * @generated
 */
public class EventPropertyNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EventPropertyNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.EventProperty_3001, getParserElement(),
					DomainVisualIDRegistry.getType(domain.diagram.edit.parts.EventPropertyNameEditPart.VISUAL_ID));
		}
		return parser;
	}
