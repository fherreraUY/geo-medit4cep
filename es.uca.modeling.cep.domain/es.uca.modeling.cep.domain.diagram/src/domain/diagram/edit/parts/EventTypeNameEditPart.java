 ...
 * @generated
 */
public class EventTypeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EventTypeNameEditPart(View view) {
		super(view);
	}
	 ...
	 * of an Event node, when the editor is loaded.
	 * @generated NOT
	 */
	protected Image getLabelIcon() {
		...
		if (eObject instanceof Event) {
			imagePath = ((Event) eObject).getImagePath();
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Event_2001, getParserElement(),
					DomainVisualIDRegistry.getType(domain.diagram.edit.parts.EventTypeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
