...
public class EventProperty2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new EventProperty2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EventPropertyName2EditPart) {
			((EventPropertyName2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureEventPropertyLabelFigure());
			return true;
		}
		if (childEditPart instanceof EventPropertyEventPropertyEventPropertiesCompartment2EditPart) {
			...
			pane.add(((EventPropertyEventPropertyEventPropertiesCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EventPropertyEventPropertyEventPropertiesCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getEventPropertyEventPropertiesCompartmentFigure();
			pane.remove(((EventPropertyEventPropertyEventPropertiesCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(EventPropertyName2EditPart.VISUAL_ID));
	}
