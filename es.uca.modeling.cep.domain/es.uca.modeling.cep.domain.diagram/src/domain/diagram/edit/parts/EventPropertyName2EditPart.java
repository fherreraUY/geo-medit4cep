 ...
 * @generated
 */
public class EventPropertyName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EventPropertyName2EditPart(View view) {
		super(view);
	}
	...
	/**
	 * This method will return the icon image from the attribute imagePath 
	 * of an EventProperty node, when the editor is loaded.
	 * @generated NOT
	 */
	protected Image getLabelIcon() {
		...
		if (eObject instanceof EventProperty) {
			imagePath = ((EventProperty) eObject).getImagePath();

			// If the path is wrong, then the default attribute image will be shown.
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.EventProperty_3002, getParserElement(),
					DomainVisualIDRegistry.getType(domain.diagram.edit.parts.EventPropertyName2EditPart.VISUAL_ID));
		}
		return parser;
	}
