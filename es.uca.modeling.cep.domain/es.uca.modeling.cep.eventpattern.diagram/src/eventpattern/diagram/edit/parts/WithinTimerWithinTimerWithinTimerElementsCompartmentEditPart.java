...
import eventpattern.diagram.edit.policies.WithinTimerWithinTimerWithinTimerElementsCompartmentCanonicalEditPolicy;
import eventpattern.diagram.edit.policies.WithinTimerWithinTimerWithinTimerElementsCompartmentItemSemanticEditPolicy;
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new WithinTimerWithinTimerWithinTimerElementsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(EventpatternVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new WithinTimerWithinTimerWithinTimerElementsCompartmentCanonicalEditPolicy());
	}
