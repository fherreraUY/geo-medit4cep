...
import eventpattern.diagram.edit.policies.GeoValue3ItemSemanticEditPolicy;
import eventpattern.diagram.part.EventpatternVisualIDRegistry;

/**
 * @generated
 */
public class GeoValue3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public GeoValue3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new GeoValue3ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof GeoValueValue3EditPart) {
			((GeoValueValue3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureGeoValueLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EventpatternVisualIDRegistry.getType(GeoValueValue3EditPart.VISUAL_ID));
	}
