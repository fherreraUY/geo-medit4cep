...
import eventpattern.diagram.edit.policies.GeoValue2ItemSemanticEditPolicy;
import eventpattern.diagram.part.EventpatternVisualIDRegistry;

/**
 * @generated
 */
public class GeoValue2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public GeoValue2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new GeoValue2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof GeoValueValue2EditPart) {
			((GeoValueValue2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureGeoValueLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EventpatternVisualIDRegistry.getType(GeoValueValue2EditPart.VISUAL_ID));
	}
