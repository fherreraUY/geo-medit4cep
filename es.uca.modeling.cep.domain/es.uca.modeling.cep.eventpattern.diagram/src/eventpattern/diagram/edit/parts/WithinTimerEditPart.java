...
import eventpattern.diagram.edit.policies.WithinTimerItemSemanticEditPolicy;
import eventpattern.diagram.part.EventpatternVisualIDRegistry;

/**
 * @generated
 */
public class WithinTimerEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public WithinTimerEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new WithinTimerItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WithinTimerYearsMonthsWeeksDaysHouEditPart) {
			((WithinTimerYearsMonthsWeeksDaysHouEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureWithinTimerLabelFigure());
			return true;
		}
		if (childEditPart instanceof WithinTimerWithinTimerWithinTimerElementsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getWithinTimerWithinTimerElementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((WithinTimerWithinTimerWithinTimerElementsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof WithinTimerWithinTimerWithinTimerElementsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getWithinTimerWithinTimerElementsCompartmentFigure();
			pane.remove(((WithinTimerWithinTimerWithinTimerElementsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
