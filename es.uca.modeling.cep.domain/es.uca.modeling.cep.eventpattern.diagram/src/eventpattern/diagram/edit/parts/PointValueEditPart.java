...
import eventpattern.diagram.edit.policies.EventpatternTextSelectionEditPolicy;
 ...
 * @generated
 */
public class PointValueEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PointValueEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = EventpatternParserProvider.getParser(EventpatternElementTypes.Point_2050, getParserElement(),
					EventpatternVisualIDRegistry.getType(eventpattern.diagram.edit.parts.PointValueEditPart.VISUAL_ID));
		}
		return parser;
	}
