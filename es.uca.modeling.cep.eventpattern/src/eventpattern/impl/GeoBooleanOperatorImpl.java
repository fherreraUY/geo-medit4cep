...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Geo Boolean Operator</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link eventpattern.impl.GeoBooleanOperatorImpl#getOutboundLink <em>Outbound Link</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class GeoBooleanOperatorImpl extends GeoOperatorImpl implements GeoBooleanOperator {
	/**
	 ...
	 * @generated
	 */
	protected GeoBooleanOperatorImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EventpatternPackage.Literals.GEO_BOOLEAN_OPERATOR;
	}
	...
	public EList<Link> getOutboundLink() {
		if (outboundLink == null) {
			outboundLink = new EObjectWithInverseResolvingEList<Link>(Link.class, this, EventpatternPackage.GEO_BOOLEAN_OPERATOR__OUTBOUND_LINK, EventpatternPackage.LINK__OPERAND);
		}
		return outboundLink;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EventpatternPackage.GEO_BOOLEAN_OPERATOR__OUTBOUND_LINK:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Operand.class) {
			switch (derivedFeatureID) {
				case EventpatternPackage.GEO_BOOLEAN_OPERATOR__OUTBOUND_LINK: return EventpatternPackage.OPERAND__OUTBOUND_LINK;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Operand.class) {
			switch (baseFeatureID) {
				case EventpatternPackage.OPERAND__OUTBOUND_LINK: return EventpatternPackage.GEO_BOOLEAN_OPERATOR__OUTBOUND_LINK;
				default: return -1;
			}
		}
		if (baseClass == EventPatternElement.class) {
