...
public class EventpatternPackageImpl extends EPackageImpl implements EventpatternPackage
{
  ...
  /**
	 ...
	 * @generated
	 */
	public EAttribute getBatchingTimeInterval_StartTimestamp() {
		return (EAttribute)batchingTimeIntervalEClass.getEStructuralFeatures().get(8);
	}
  ...
  public void createPackageContents()
  {
		...
		createEAttribute(batchingTimeIntervalEClass, BATCHING_TIME_INTERVAL__START_TIMESTAMP);
  ...
  public void initializePackageContents()
  {
		...
		complexEventEClass.getESuperTypes().add(this.getOperator());
		...
		initEAttribute(getBatchingTimeInterval_StartTimestamp(), ecorePackage.getELong(), "startTimestamp", null, 0, 1, BatchingTimeInterval.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
