...
public class EventpatternViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = EventpatternVisualIDRegistry.getNodeVisualID(op.getContainerView(), domainElement);
		} else {
			visualID = EventpatternVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!EventpatternElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null && visualID != EventpatternVisualIDRegistry
						.getNodeVisualID(op.getContainerView(), domainElement)) {
					return false; // visual id for node EClass should match visual id from element type
				}
			} else {
				if (!CEPEventPatternEditPart.MODEL_ID
						.equals(EventpatternVisualIDRegistry.getModelID(op.getContainerView()))) {
		...
		return ContainsEditPart.VISUAL_ID == visualID || AndEditPart.VISUAL_ID == visualID
				...
				|| MultiplicationEditPart.VISUAL_ID == visualID || DivisionEditPart.VISUAL_ID == visualID
				|| ModulusEditPart.VISUAL_ID == visualID || EqualEditPart.VISUAL_ID == visualID
				|| NotEqualEditPart.VISUAL_ID == visualID || LessThanEditPart.VISUAL_ID == visualID
				|| GreaterThanEditPart.VISUAL_ID == visualID || LessEqualEditPart.VISUAL_ID == visualID
				|| GreaterEqualEditPart.VISUAL_ID == visualID || EveryEditPart.VISUAL_ID == visualID
				|| EveryDistinctEditPart.VISUAL_ID == visualID || RepeatEditPart.VISUAL_ID == visualID
				|| UntilEditPart.VISUAL_ID == visualID || RangeEditPart.VISUAL_ID == visualID
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = EventpatternVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null && visualID != EventpatternVisualIDRegistry.getLinkWithClassVisualID(domainElement)) {
	...
	public Diagram createDiagram(IAdaptable semanticAdapter, String diagramKind, PreferencesHint preferencesHint) {
		...
		diagram.setType(CEPEventPatternEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		if (semanticHint == null) {
			visualID = EventpatternVisualIDRegistry.getNodeVisualID(containerView, domainElement);
		} else {
			visualID = EventpatternVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case ContainsEditPart.VISUAL_ID:
			return createContains_2041(domainElement, containerView, index, persisted, preferencesHint);
		case AndEditPart.VISUAL_ID:
			return createAnd_2001(domainElement, containerView, index, persisted, preferencesHint);
		case OrEditPart.VISUAL_ID:
			return createOr_2002(domainElement, containerView, index, persisted, preferencesHint);
		case NotEditPart.VISUAL_ID:
		...
		case DistanceEditPart.VISUAL_ID:
			return createDistance_2045(domainElement, containerView, index, persisted, preferencesHint);
		case EqualsEditPart.VISUAL_ID:
			return createEquals_2046(domainElement, containerView, index, persisted, preferencesHint);
		case IntersectsEditPart.VISUAL_ID:
			return createIntersects_2047(domainElement, containerView, index, persisted, preferencesHint);
		case AdditionEditPart.VISUAL_ID:
			return createAddition_2004(domainElement, containerView, index, persisted, preferencesHint);
		case SubtractionEditPart.VISUAL_ID:
			return createSubtraction_2005(domainElement, containerView, index, persisted, preferencesHint);
		case MultiplicationEditPart.VISUAL_ID:
			return createMultiplication_2006(domainElement, containerView, index, persisted, preferencesHint);
		case DivisionEditPart.VISUAL_ID:
			return createDivision_2007(domainElement, containerView, index, persisted, preferencesHint);
		case ModulusEditPart.VISUAL_ID:
			return createModulus_2008(domainElement, containerView, index, persisted, preferencesHint);
		case EqualEditPart.VISUAL_ID:
			return createEqual_2009(domainElement, containerView, index, persisted, preferencesHint);
		case NotEqualEditPart.VISUAL_ID:
			return createNotEqual_2010(domainElement, containerView, index, persisted, preferencesHint);
		case LessThanEditPart.VISUAL_ID:
			return createLessThan_2011(domainElement, containerView, index, persisted, preferencesHint);
		case GreaterThanEditPart.VISUAL_ID:
			return createGreaterThan_2012(domainElement, containerView, index, persisted, preferencesHint);
		case LessEqualEditPart.VISUAL_ID:
			return createLessEqual_2013(domainElement, containerView, index, persisted, preferencesHint);
		case GreaterEqualEditPart.VISUAL_ID:
			return createGreaterEqual_2014(domainElement, containerView, index, persisted, preferencesHint);
		case EveryEditPart.VISUAL_ID:
			return createEvery_2015(domainElement, containerView, index, persisted, preferencesHint);
		case EveryDistinctEditPart.VISUAL_ID:
			return createEveryDistinct_2016(domainElement, containerView, index, persisted, preferencesHint);
		case RepeatEditPart.VISUAL_ID:
			return createRepeat_2017(domainElement, containerView, index, persisted, preferencesHint);
		case UntilEditPart.VISUAL_ID:
			return createUntil_2018(domainElement, containerView, index, persisted, preferencesHint);
		case RangeEditPart.VISUAL_ID:
			return createRange_2019(domainElement, containerView, index, persisted, preferencesHint);
		case FollowedByEditPart.VISUAL_ID:
			return createFollowedBy_2020(domainElement, containerView, index, persisted, preferencesHint);
		case WhileEditPart.VISUAL_ID:
			return createWhile_2021(domainElement, containerView, index, persisted, preferencesHint);
		case MaxEditPart.VISUAL_ID:
			return createMax_2022(domainElement, containerView, index, persisted, preferencesHint);
		case MinEditPart.VISUAL_ID:
			return createMin_2023(domainElement, containerView, index, persisted, preferencesHint);
		case AvgEditPart.VISUAL_ID:
			return createAvg_2024(domainElement, containerView, index, persisted, preferencesHint);
		case CountEditPart.VISUAL_ID:
		...
		case TimeIntervalEditPart.VISUAL_ID:
			return createTimeInterval_2031(domainElement, containerView, index, persisted, preferencesHint);
		case TimeScheduleEditPart.VISUAL_ID:
			return createTimeSchedule_2032(domainElement, containerView, index, persisted, preferencesHint);
		case EmailEditPart.VISUAL_ID:
			return createEmail_2033(domainElement, containerView, index, persisted, preferencesHint);
		case TwitterEditPart.VISUAL_ID:
			return createTwitter_2039(domainElement, containerView, index, persisted, preferencesHint);
		case SlidingEventIntervalEditPart.VISUAL_ID:
			return createSlidingEventInterval_2034(domainElement, containerView, index, persisted, preferencesHint);
		case BatchingEventIntervalEditPart.VISUAL_ID:
			return createBatchingEventInterval_2035(domainElement, containerView, index, persisted, preferencesHint);
		case SlidingTimeIntervalEditPart.VISUAL_ID:
			return createSlidingTimeInterval_2036(domainElement, containerView, index, persisted, preferencesHint);
		case BatchingTimeIntervalEditPart.VISUAL_ID:
		...
		case EventProperty3EditPart.VISUAL_ID:
			return createEventProperty_3002(domainElement, containerView, index, persisted, preferencesHint);
		case Contains2EditPart.VISUAL_ID:
			return createContains_3061(domainElement, containerView, index, persisted, preferencesHint);
		case And2EditPart.VISUAL_ID:
			return createAnd_3003(domainElement, containerView, index, persisted, preferencesHint);
		case Or2EditPart.VISUAL_ID:
			return createOr_3004(domainElement, containerView, index, persisted, preferencesHint);
		case Not2EditPart.VISUAL_ID:
		...
		case Distance2EditPart.VISUAL_ID:
			return createDistance_3065(domainElement, containerView, index, persisted, preferencesHint);
		case Equals2EditPart.VISUAL_ID:
			return createEquals_3066(domainElement, containerView, index, persisted, preferencesHint);
		case Intersects2EditPart.VISUAL_ID:
			return createIntersects_3067(domainElement, containerView, index, persisted, preferencesHint);
		case Addition2EditPart.VISUAL_ID:
			return createAddition_3006(domainElement, containerView, index, persisted, preferencesHint);
		case Subtraction2EditPart.VISUAL_ID:
			return createSubtraction_3007(domainElement, containerView, index, persisted, preferencesHint);
		case Multiplication2EditPart.VISUAL_ID:
			return createMultiplication_3008(domainElement, containerView, index, persisted, preferencesHint);
		case Division2EditPart.VISUAL_ID:
			return createDivision_3009(domainElement, containerView, index, persisted, preferencesHint);
		case Modulus2EditPart.VISUAL_ID:
			return createModulus_3010(domainElement, containerView, index, persisted, preferencesHint);
		case Equal2EditPart.VISUAL_ID:
			return createEqual_3011(domainElement, containerView, index, persisted, preferencesHint);
		case NotEqual2EditPart.VISUAL_ID:
			return createNotEqual_3012(domainElement, containerView, index, persisted, preferencesHint);
		case LessThan2EditPart.VISUAL_ID:
			return createLessThan_3013(domainElement, containerView, index, persisted, preferencesHint);
		case GreaterThan2EditPart.VISUAL_ID:
			return createGreaterThan_3014(domainElement, containerView, index, persisted, preferencesHint);
		case LessEqual2EditPart.VISUAL_ID:
			return createLessEqual_3015(domainElement, containerView, index, persisted, preferencesHint);
		case GreaterEqual2EditPart.VISUAL_ID:
			return createGreaterEqual_3016(domainElement, containerView, index, persisted, preferencesHint);
		case Every2EditPart.VISUAL_ID:
			return createEvery_3017(domainElement, containerView, index, persisted, preferencesHint);
		case EveryDistinct2EditPart.VISUAL_ID:
			return createEveryDistinct_3018(domainElement, containerView, index, persisted, preferencesHint);
		case Repeat2EditPart.VISUAL_ID:
			return createRepeat_3019(domainElement, containerView, index, persisted, preferencesHint);
		case Until2EditPart.VISUAL_ID:
			return createUntil_3020(domainElement, containerView, index, persisted, preferencesHint);
		case Range2EditPart.VISUAL_ID:
			return createRange_3021(domainElement, containerView, index, persisted, preferencesHint);
		case FollowedBy2EditPart.VISUAL_ID:
		...
		case And3EditPart.VISUAL_ID:
			return createAnd_3027(domainElement, containerView, index, persisted, preferencesHint);
		case Or3EditPart.VISUAL_ID:
			return createOr_3028(domainElement, containerView, index, persisted, preferencesHint);
		case Not3EditPart.VISUAL_ID:
		...
		case Distance3EditPart.VISUAL_ID:
			return createDistance_3072(domainElement, containerView, index, persisted, preferencesHint);
		case Equals3EditPart.VISUAL_ID:
			return createEquals_3073(domainElement, containerView, index, persisted, preferencesHint);
		case Intersects3EditPart.VISUAL_ID:
			return createIntersects_3074(domainElement, containerView, index, persisted, preferencesHint);
		case Addition3EditPart.VISUAL_ID:
			return createAddition_3030(domainElement, containerView, index, persisted, preferencesHint);
		case Subtraction3EditPart.VISUAL_ID:
			return createSubtraction_3031(domainElement, containerView, index, persisted, preferencesHint);
		case Multiplication3EditPart.VISUAL_ID:
			return createMultiplication_3032(domainElement, containerView, index, persisted, preferencesHint);
		case Division3EditPart.VISUAL_ID:
			return createDivision_3033(domainElement, containerView, index, persisted, preferencesHint);
		case Modulus3EditPart.VISUAL_ID:
			return createModulus_3034(domainElement, containerView, index, persisted, preferencesHint);
		case Equal3EditPart.VISUAL_ID:
			return createEqual_3035(domainElement, containerView, index, persisted, preferencesHint);
		case NotEqual3EditPart.VISUAL_ID:
			return createNotEqual_3036(domainElement, containerView, index, persisted, preferencesHint);
		case LessThan3EditPart.VISUAL_ID:
			return createLessThan_3037(domainElement, containerView, index, persisted, preferencesHint);
		case GreaterThan3EditPart.VISUAL_ID:
			return createGreaterThan_3038(domainElement, containerView, index, persisted, preferencesHint);
		case LessEqual3EditPart.VISUAL_ID:
			return createLessEqual_3039(domainElement, containerView, index, persisted, preferencesHint);
		case GreaterEqual3EditPart.VISUAL_ID:
			return createGreaterEqual_3040(domainElement, containerView, index, persisted, preferencesHint);
		case Every3EditPart.VISUAL_ID:
			return createEvery_3041(domainElement, containerView, index, persisted, preferencesHint);
		case EveryDistinct3EditPart.VISUAL_ID:
			return createEveryDistinct_3042(domainElement, containerView, index, persisted, preferencesHint);
		case Repeat3EditPart.VISUAL_ID:
			return createRepeat_3043(domainElement, containerView, index, persisted, preferencesHint);
		case Until3EditPart.VISUAL_ID:
			return createUntil_3044(domainElement, containerView, index, persisted, preferencesHint);
		case Range3EditPart.VISUAL_ID:
			return createRange_3045(domainElement, containerView, index, persisted, preferencesHint);
		case FollowedBy3EditPart.VISUAL_ID:
			return createFollowedBy_3046(domainElement, containerView, index, persisted, preferencesHint);
		case While3EditPart.VISUAL_ID:
			return createWhile_3047(domainElement, containerView, index, persisted, preferencesHint);
		case Max2EditPart.VISUAL_ID:
			return createMax_3048(domainElement, containerView, index, persisted, preferencesHint);
		case Min2EditPart.VISUAL_ID:
			return createMin_3049(domainElement, containerView, index, persisted, preferencesHint);
		case Avg2EditPart.VISUAL_ID:
			return createAvg_3050(domainElement, containerView, index, persisted, preferencesHint);
		case Count2EditPart.VISUAL_ID:
		...
		case TimeInterval2EditPart.VISUAL_ID:
			return createTimeInterval_3057(domainElement, containerView, index, persisted, preferencesHint);
		case TimeSchedule2EditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (EventpatternVisualIDRegistry.getVisualID(elementTypeHint)) {
		case LinkEditPart.VISUAL_ID:
			return createLink_4001(getSemanticElement(semanticAdapter), containerView, index, persisted,
					preferencesHint);
		}
	...
	* @generated
	*/
	public Node createContains_2041(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(ContainsEditPart.VISUAL_ID));
	...
	public Node createAnd_2001(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(AndEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createOr_2002(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(OrEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createNot_2003(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(NotEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	* @generated
	*/
	public Node createUnion_2042(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(UnionEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	* @generated
	*/
	public Node createDiference_2044(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(DiferenceEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	* @generated
	*/
	public Node createDistance_2045(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(DistanceEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	* @generated
	*/
	public Node createEquals_2046(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(EqualsEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	* @generated
	*/
	public Node createIntersects_2047(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(IntersectsEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createAddition_2004(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(AdditionEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createSubtraction_2005(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(SubtractionEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createMultiplication_2006(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(MultiplicationEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createDivision_2007(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(DivisionEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createModulus_2008(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(ModulusEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createEqual_2009(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(EqualEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createNotEqual_2010(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(NotEqualEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createLessThan_2011(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(LessThanEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createGreaterThan_2012(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(GreaterThanEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createLessEqual_2013(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(LessEqualEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createGreaterEqual_2014(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(GreaterEqualEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createEvery_2015(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(EveryEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createEveryDistinct_2016(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(EveryDistinctEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createRepeat_2017(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(RepeatEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5017 = createLabel(node, EventpatternVisualIDRegistry.getType(RepeatCountEditPart.VISUAL_ID));
		return node;
	}
	...
	public Node createUntil_2018(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(UntilEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createRange_2019(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(RangeEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createFollowedBy_2020(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(FollowedByEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createWhile_2021(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(WhileEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createMax_2022(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(MaxEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createMin_2023(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(MinEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createAvg_2024(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(AvgEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createCount_2025(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(CountEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createSum_2026(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(SumEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createEvent_2027(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(EventEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE.getFillStyle_FillColor(),
				FigureUtilities.RGBToInteger(fillRGB));
		Node label5029 = createLabel(node, EventpatternVisualIDRegistry.getType(EventTypeNameEditPart.VISUAL_ID));
		createCompartment(node,
				EventpatternVisualIDRegistry.getType(EventEventEventPropertiesCompartmentEditPart.VISUAL_ID), true,
				false, true, true);
		return node;
	}
	...
	public Node createEventProperty_2028(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(EventPropertyEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE.getFillStyle_FillColor(),
				FigureUtilities.RGBToInteger(fillRGB));
		Node label5030 = createLabel(node, EventpatternVisualIDRegistry.getType(EventPropertyNameEditPart.VISUAL_ID));
		createCompartment(node,
	...
	public Node createValue_2029(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFillStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(ValueEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	*/
	...
	public Node createWithinTimer_2030(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(WithinTimerEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createTimeInterval_2031(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(TimeIntervalEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createTimeSchedule_2032(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(TimeScheduleEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createEmail_2033(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(EmailEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createTwitter_2039(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(TwitterEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createSlidingEventInterval_2034(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(SlidingEventIntervalEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		createCompartment(node,
				EventpatternVisualIDRegistry.getType(
	...
	public Node createBatchingEventInterval_2035(EObject domainElement, View containerView, int index,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(BatchingEventIntervalEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createSlidingTimeInterval_2036(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(SlidingTimeIntervalEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createBatchingTimeInterval_2037(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(BatchingTimeIntervalEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createComplexEvent_2038(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(ComplexEventEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createEventProperty_3001(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(EventProperty2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE.getFillStyle_FillColor(),
				FigureUtilities.RGBToInteger(fillRGB));
		Node label5028 = createLabel(node, EventpatternVisualIDRegistry.getType(EventPropertyName2EditPart.VISUAL_ID));
		createCompartment(node,
				EventpatternVisualIDRegistry
	...
	public Node createEventProperty_3002(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(EventProperty3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE.getFillStyle_FillColor(),
				FigureUtilities.RGBToInteger(fillRGB));
		Node label5027 = createLabel(node, EventpatternVisualIDRegistry.getType(EventPropertyName3EditPart.VISUAL_ID));
		createCompartment(node,
				EventpatternVisualIDRegistry
	...
	* @generated
	*/
	public Node createContains_3061(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Contains2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createAnd_3003(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(And2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createOr_3004(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Or2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createNot_3005(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Not2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	* @generated
	*/
	public Node createUnion_3062(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Union2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	* @generated
	*/
	public Node createDiference_3064(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Diference2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	* @generated
	*/
	public Node createDistance_3065(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Distance2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	* @generated
	*/
	public Node createEquals_3066(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Equals2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	* @generated
	*/
	public Node createIntersects_3067(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Intersects2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createAddition_3006(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Addition2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createSubtraction_3007(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Subtraction2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createMultiplication_3008(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Multiplication2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createDivision_3009(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Division2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createModulus_3010(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Modulus2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createEqual_3011(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Equal2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createNotEqual_3012(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(NotEqual2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createLessThan_3013(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(LessThan2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createGreaterThan_3014(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(GreaterThan2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createLessEqual_3015(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(LessEqual2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createGreaterEqual_3016(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(GreaterEqual2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createEvery_3017(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Every2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createEveryDistinct_3018(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(EveryDistinct2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createRepeat_3019(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Repeat2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		...
		Node label5048 = createLabel(node, EventpatternVisualIDRegistry.getType(RepeatCount2EditPart.VISUAL_ID));
		return node;
	}
	...
	public Node createUntil_3020(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Until2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createRange_3021(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Range2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createFollowedBy_3022(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(FollowedBy2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createWhile_3023(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(While2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createEvent_3024(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Event2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE.getFillStyle_FillColor(),
				FigureUtilities.RGBToInteger(fillRGB));
		Node label5053 = createLabel(node, EventpatternVisualIDRegistry.getType(EventTypeName2EditPart.VISUAL_ID));
		createCompartment(node,
				EventpatternVisualIDRegistry.getType(EventEventEventPropertiesCompartment2EditPart.VISUAL_ID), true,
				false, true, true);
		return node;
	}
	...
	public Node createEventProperty_3025(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(EventProperty4EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE.getFillStyle_FillColor(),
				FigureUtilities.RGBToInteger(fillRGB));
		Node label5054 = createLabel(node, EventpatternVisualIDRegistry.getType(EventPropertyName4EditPart.VISUAL_ID));
		createCompartment(node,
				EventpatternVisualIDRegistry
	...
	public Node createValue_3026(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFillStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Value2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	* @generated
	*/
	public Node createContains_3068(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Contains3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createAnd_3027(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(And3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createOr_3028(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Or3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createNot_3029(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Not3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	* @generated
	*/
	public Node createUnion_3069(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Union3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	* @generated
	*/
	public Node createDiference_3071(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Diference3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	* @generated
	*/
	public Node createDistance_3072(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Distance3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	* @generated
	*/
	public Node createEquals_3073(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Equals3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	* @generated
	*/
	public Node createIntersects_3074(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Intersects3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createAddition_3030(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Addition3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createSubtraction_3031(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Subtraction3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createMultiplication_3032(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Multiplication3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createDivision_3033(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Division3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createModulus_3034(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Modulus3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createEqual_3035(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Equal3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createNotEqual_3036(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(NotEqual3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createLessThan_3037(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(LessThan3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createGreaterThan_3038(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(GreaterThan3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createLessEqual_3039(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(LessEqual3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createGreaterEqual_3040(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(GreaterEqual3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createEvery_3041(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Every3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createEveryDistinct_3042(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(EveryDistinct3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createRepeat_3043(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Repeat3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		...
		Node label5076 = createLabel(node, EventpatternVisualIDRegistry.getType(RepeatCount3EditPart.VISUAL_ID));
		return node;
	}
	...
	public Node createUntil_3044(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Until3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createRange_3045(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Range3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createFollowedBy_3046(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(FollowedBy3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createWhile_3047(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(While3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createMax_3048(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Max2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createMin_3049(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Min2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createAvg_3050(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Avg2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createCount_3051(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Count2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createSum_3052(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Sum2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createEvent_3053(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Event3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE.getFillStyle_FillColor(),
				FigureUtilities.RGBToInteger(fillRGB));
		Node label5086 = createLabel(node, EventpatternVisualIDRegistry.getType(EventTypeName3EditPart.VISUAL_ID));
		createCompartment(node,
				EventpatternVisualIDRegistry.getType(EventEventEventPropertiesCompartment3EditPart.VISUAL_ID), true,
				false, true, true);
		return node;
	}
	...
	public Node createEventProperty_3054(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(EventProperty5EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE.getFillStyle_FillColor(),
				FigureUtilities.RGBToInteger(fillRGB));
		Node label5087 = createLabel(node, EventpatternVisualIDRegistry.getType(EventPropertyName5EditPart.VISUAL_ID));
		createCompartment(node,
				EventpatternVisualIDRegistry
	...
	public Node createValue_3055(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFillStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(Value3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	*/
	...
	public Node createWithinTimer_3056(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(WithinTimer2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createTimeInterval_3057(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(TimeInterval2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createTimeSchedule_3058(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(TimeSchedule2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createComplexEventProperty_3059(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFillStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EventpatternVisualIDRegistry.getType(ComplexEventPropertyEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Edge createLink_4001(EObject domainElement, View containerView, int index, boolean persisted,
		...
		edge.setType(EventpatternVisualIDRegistry.getType(LinkEditPart.VISUAL_ID));
		...
		Node label6001 = createLabel(edge, EventpatternVisualIDRegistry.getType(LinkOrderEditPart.VISUAL_ID));
	...
	private void stampShortcut(View containerView, Node target) {
		if (!CEPEventPatternEditPart.MODEL_ID.equals(EventpatternVisualIDRegistry.getModelID(containerView))) {
			...
			shortcutAnnotation.getDetails().put("modelID", CEPEventPatternEditPart.MODEL_ID); //$NON-NLS-1$
