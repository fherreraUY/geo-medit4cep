...
public class WithinTimerWithinTimerWithinTimerElementsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<EventpatternNodeDescriptor> childDescriptors = EventpatternDiagramUpdater
				.getWithinTimerWithinTimerWithinTimerElementsCompartment_7005SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<EventpatternNodeDescriptor> childDescriptors = EventpatternDiagramUpdater
				.getWithinTimerWithinTimerWithinTimerElementsCompartment_7005SemanticChildren(
