...
import eventpattern.diagram.edit.policies.BatchingEventIntervalBatchingEventIntervalEventPatternConditionsCompartmentCanonicalEditPolicy;
import eventpattern.diagram.edit.policies.BatchingEventIntervalBatchingEventIntervalEventPatternConditionsCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class BatchingEventIntervalBatchingEventIntervalEventPatternConditionsCompartmentEditPart
	 ...
	 * @generated
	 */
	public BatchingEventIntervalBatchingEventIntervalEventPatternConditionsCompartmentEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.BatchingEventIntervalBatchingEventIntervalEventPatternConditionsCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new BatchingEventIntervalBatchingEventIntervalEventPatternConditionsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(EventpatternVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new BatchingEventIntervalBatchingEventIntervalEventPatternConditionsCompartmentCanonicalEditPolicy());
	}
