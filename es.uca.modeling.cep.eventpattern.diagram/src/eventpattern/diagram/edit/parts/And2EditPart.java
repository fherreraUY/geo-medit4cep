...
import eventpattern.diagram.edit.policies.And2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class And2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new And2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new AndFigure();
	}
	 ...
	 * @generated
	 */
	public class AndFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public AndFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.cep.eventpattern.figures/svg/And.svg");
