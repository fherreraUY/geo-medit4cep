 ...
 * @generated
 */
public class GeoValueValue3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public GeoValueValue3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = EventpatternParserProvider.getParser(EventpatternElementTypes.GeoValue_3078, getParserElement(),
					EventpatternVisualIDRegistry
							.getType(eventpattern.diagram.edit.parts.GeoValueValue3EditPart.VISUAL_ID));
		}
		return parser;
	}
